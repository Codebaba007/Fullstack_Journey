...
After saving the README and project files:
...
git commit -m "Week 7 Day 5 - JavaScript Arrow Functions"
...
Do not use `git push` by itself because the `origin` remote is configured for the Mehedi032003 account.
...
to push this day's work to the backup account.