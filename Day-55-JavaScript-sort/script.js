...
console.log("First student with CGPA >= 3.75:", student);
const student2 = students.find((student) =>{
    return student.cgpa < 3.75;
});
console.log("First student with CGPA < 3.75:", student2);

const student3 = students.find((student) =>student.cgpa >= 4.00);
if(student3){
    console.log("Student with CGPA >= 4.00:", student3);
}
else{
    console.log("No student found with CGPA >= 4.00");
}
const student4 = students.find((student)=> (student.cgpa >-3.70 && student.department === "Computer Science") || (student.cgpa >= 3.85 && student.department === "Software Engineering"));
console.log("First student meeting the criteria:", student4);
const searchName = "Nusrat Jahan";
const student5 = students.find((student) => student.name === searchName);
if(student5){
    console.log("Student found:", student5);
}
else{
    console.log("No student found with the name:", searchName);
}
const searchCGPA = 3.80;

const student6 = students.find((student) => {
    return student.cgpa >= searchCGPA;
});

if (student6) {
    console.log("Student found:");
    console.log("Name:", student6.name);
    console.log("CGPA:", student6.cgpa);
    console.log("Department:", student6.department);
} else {
...
console.log("Is there a number greater than 25?", result);
const students = [
    {
        name: "Rahim Ahmed",
        cgpa: 3.75,
...
const studentWithHighCgpa = students.some((student) => {
    return student.cgpa >= 3.80
});
console.log("Is there any student with CGPA >= 3.80?", studentWithHighCgpa);
const hasCSEStudent = students.some((student) => {
    return student.department === "Computer Science";
});
console.log("Is there any student in Computer Science department?", hasCSEStudent);

const studentFindout = students.some((student)=>{
    return student.cgpa >= 3.80 && student.department === "Software Engineering";
}); 
console.log("Good software student: ", studentFindout);
const requiredCgpa = 3.90;

const hasQualifiedStudent = students.some((student) => {
    return student.cgpa >= requiredCgpa;
});
if (hasQualifiedStudent) {
    console.log("There is at least one student with CGPA >= " + requiredCgpa);
}  else{
    console.log("No student found with required CGPA: " + requiredCgpa);
}
const hasHighAchiever = students.some((student) => {
    return student.cgpa >= 3.5 && student.department === "Computer Science";
});
if (hasHighAchiever) {
...
console.log("Are all numbers greater than or equal to 10?", result);
const result1 = numbers.every((number) => {
    return number >= 30;
});
console.log("Are all numbers greater than or equal to 30?", result1);
const students = [
    {
        name: "Rahim Ahmed",
        cgpa: 3.75,
...
const eligibleForScholarship = students.every((student) => {
    return student.cgpa >= 3.70;
});
console.log("Are all students eligible for scholarship?", eligibleForScholarship);*/
...
console.log("Students sorted by CGPA (ascending):", students);