...
const scStudents = students.filter((student)=> student.department === "Computer Science");
console.log(scStudents);

const qaulitfiedStudents = scStudents.filter((student) => student.cgpa >= 3.75);
console.log("Qualified Students: ", qaulitfiedStudents);
...
const qualifiedStudents = students
    ...
    qualifiedStudents.forEach((student, index) => {
...
const qualifiedStudents = csStudents.filter((student) => student.cgpa >= 3.70);
const sortedQualifiedStudents = qualifiedStudents.sort((a, b) => b.cgpa - a.cgpa);
console.log(sortedQualifiedStudents);

const studentSorted = students
    .filter((student) => student.department === "Computer Science")
    .filter((student) => student.cgpa >= 3.70)
    .sort((a, b) => b.cgpa - a.cgpa);  
    studentSorted.forEach((student, index) => {
        console.log(`${index + 1}. ${student.name} - CGPA: ${student.cgpa}`);
    }); 

const studentContainer = document.getElementById("studentContainer");

const studentName = document.createElement("p");
studentName.textContent = "Name: Rahim Ahmed";
...
const studentName2 = document.createElement("h2");
studentName2.textContent = "Name: Rahim Ahmed";
const studentCgpa = document.createElement("p");
studentCgpa.textContent = "CGPA: 3.75";
studentCard.appendChild(studentName2);
